      ...
      <div class="row">
        <div class="site site--main">
          <header class="site__header">
            ...
            <a href="{{ route('kontrakan.create' )}}" class="btn btn-primary" style="margin-right:10px;">Tambah Rumah Dijual</a>
            <a href="/kontrakansaya" class="btn btn-warning" style="margin-right:10px;">Rumah yang Saya Jual</a>
          </header>
        ...
        <div class="sidebar">
          <div class="widget js-widget widget--sidebar">
            <div class="widget__header">
              ...
              <h5 class="widget__headline">Cari Rumah DiJual dengan menggunakan filter kecamatan.</h5>
            </div>
            <div class="widget__content">
              <!-- BEGIN SEARCH-->
                <div class="row">
