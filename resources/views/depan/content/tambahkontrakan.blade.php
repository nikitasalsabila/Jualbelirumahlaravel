          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <h1 class="text-center">Tambah Rumah DiJual</h1>
                <br>
                <form enctype="multipart/form-data" action="{{ route('kontrakan.store') }}" method="post">
                  {{ csrf_field() }}
                  <div class="form-group">
                    <label for="judul">Nama Perumahan/Pemilik</label>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="isi" cols="80" class="form-control" required="true"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="foto">Luas Area Rumah</label>
                    <input type="text" name="luastanah" class="form-control" required="true">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="jlhkamarmandi" class="form-control" required="true">
                  </div>
                  <div class="form-group">
                    <label for="jlhkamar">Jumlah Kamar</label>
                    <input type="number" name="jlhkamar" class="form-control" required="true">
                  </div>
                  <div class="form-group">
